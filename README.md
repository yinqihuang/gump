...
I created this specifically for the project as it nicely presents all the data points on a horizontal line (which is a good analogy of the timeline of the movie). An arc connects two correlated events. Here I use chi-square test to adjust the line weights representing the strength of correlation, but you can replace it with any statistical tool that you want to use.
